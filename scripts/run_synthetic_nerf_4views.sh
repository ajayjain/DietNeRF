...
## Test
CUDA_VISIBLE_DEVICES=2 python run_nerf.py --render_only --render_test --config configs/223_blender_lego_4views.txt &
CUDA_VISIBLE_DEVICES=3 python run_nerf.py --render_only --render_test --config configs/224_blender_mic_4views.txt &
wait;
CUDA_VISIBLE_DEVICES=2 python run_nerf.py --render_only --render_test --config configs/225_blender_ship_4views.txt &

# CUDA_VISIBLE_DEVICES=3 --render_only --render_test python run_nerf.py --config configs/220_blender_chair_4views.txt &
# CUDA_VISIBLE_DEVICES=6 --render_only --render_test python run_nerf.py --config configs/221_blender_drums_4views.txt &
# CUDA_VISIBLE_DEVICES=7 --render_only --render_test python run_nerf.py --config configs/222_blender_ficus_4views.txt &
