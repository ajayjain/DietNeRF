...
# CUDA_VISIBLE_DEVICES=3 python run_nerf.py --config configs/hotdog.txt &
# CUDA_VISIBLE_DEVICES=4 python run_nerf.py --config configs/materials.txt &
...
CUDA_VISIBLE_DEVICES=3 python run_nerf.py --render_only --render_test --config configs/hotdog.txt &
CUDA_VISIBLE_DEVICES=4 python run_nerf.py --render_only --render_test --config configs/materials.txt &