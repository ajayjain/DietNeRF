...
CUDA_VISIBLE_DEVICES=6 python run_nerf.py --config configs/dietnerf_ft_8v/287_blender_materials_8views_ftctr258_200k.txt &
CUDA_VISIBLE_DEVICES=7 python run_nerf.py --config configs/dietnerf_ft_8v/288_blender_hotdog_8views_ftctr_200k.txt &
wait;
...
CUDA_VISIBLE_DEVICES=6 python run_nerf.py --render_only --render_test --reload_iter 250000 --config configs/dietnerf_ft_8v/288_blender_hotdog_8views_ftctr_200k.txt &
CUDA_VISIBLE_DEVICES=7 python run_nerf.py --render_only --render_test --reload_iter 250000 --config configs/dietnerf_ft_8v/287_blender_materials_8views_ftctr_200k.txt &
wait;
...
cp -r logs/286_blender_lego_8views_ftctr042/testset_250000/ logs/dietnerfft_images_8/lego_testset_250000
cp -r logs/287_blender_materials_8views_ftctr258_200k/testset_250000/ logs/dietnerfft_images_8/materials_testset_250000
cp -r logs/288_blender_hotdog_8views_ftctr256_200k/testset_250000/ logs/dietnerfft_images_8/hotdog_testset_250000
