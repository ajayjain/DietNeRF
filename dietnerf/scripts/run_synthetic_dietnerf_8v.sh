...
CUDA_VISIBLE_DEVICES=3 python run_nerf.py --config configs/dietnerf_8v/042_blender_paper_lego.txt &
...
CUDA_VISIBLE_DEVICES=7 python run_nerf.py --config configs/dietnerf_8v/258_blender_materials_8views_ctr.txt &
wait;
...
CUDA_VISIBLE_DEVICES=3 python run_nerf.py --render_only --render_test --config configs/dietnerf_8v/042_blender_paper_lego.txt &
...
CUDA_VISIBLE_DEVICES=7 python run_nerf.py --render_only --render_test --config configs/dietnerf_8v/258_blender_materials_8views_ctr.txt &
wait;
...
cp -r logs/042_blender_paper_lego_ctr_coarseandfine_clip_vit_reuseemb_uniformpose/testset_200000 logs/dietnerf_images_8/lego_testset_200000
...
cp -r logs/258_blender_materials_8views_ctr/testset_200000 logs/dietnerf_images_8/materials_testset_200000
