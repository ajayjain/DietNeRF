...
```
git clone git@github.com:ajayjain/CLIP.git
```

Set up NeRF repository:
```
git clone git@github.com:ajayjain/consistent_nerf.git nerf-pytorch
cd nerf-pytorch
mkdir logs/
mkdir data/
cd data/
